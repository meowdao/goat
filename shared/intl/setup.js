...
import idData from "./localization/id";
import idCountries from "./localization/countries.id.json";
idData.countries = idCountries;
addLocaleData(id);
localization.id = {
	id: "id",
	messages: flattenMessages(idData)
};

import "intl/locale-data/jsonp/ru";
import ru from "react-intl/locale-data/ru";
import ruData from "./localization/ru";
import ruCountries from "./localization/countries.ru.json";
ruData.countries = ruCountries;
addLocaleData(ru);
localization.ru = {
	id: "ru",
